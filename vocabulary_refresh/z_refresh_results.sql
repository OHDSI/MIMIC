...
+----------+-----------------------------------------------------------+-----------+
|       12 | wrong relationships: "Maps to"/"Maps to value" not to "S" |         2 |
+----------+-----------------------------------------------------------+-----------+
done!
...
-- -----------------------------------------------------------------------------------
-- 2021-01-26
-- Remove duplicated measurement mapping
-- -----------------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------------
-- 2021-02-03
-- Replace labevents mapping with the new one (reviewed)
-- -----------------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------------
-- 2021-02-15
-- Add 30 drug codes with pharmacy.medication, replace 16 codes with new source codes
-- -----------------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------------
-- 2021-02-19
-- Add more codes for visit_detail, specimen, measurements
-- -----------------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------------
-- 2021-02-20
-- Small update for language, waveform
-- -----------------------------------------------------------------------------------
