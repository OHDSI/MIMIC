...
#standardsql
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.voc_concept (
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.voc_vocabulary (
  vocabulary_id         STRING      not null,
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.voc_domain (
  domain_id         STRING      not null,
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.voc_concept_class (
  concept_class_id          STRING      not null,
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.voc_concept_relationship (
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.voc_relationship (
  relationship_id         STRING      not null,
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.voc_concept_synonym (
  concept_id            INT64       not null,
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.voc_concept_ancestor (
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.voc_source_to_concept_map (
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.voc_drug_strength (
