...
CREATE OR REPLACE TABLE @etl_project.@etl_dataset.cohort_definition (
...
CREATE OR REPLACE TABLE @etl_project.@etl_dataset.attribute_definition (
...
--HINT DISTRIBUTE_ON_KEY(subject_id)
CREATE OR REPLACE TABLE @etl_project.@etl_dataset.cohort_attribute
(
  cohort_definition_id    INT64     not null ,
  subject_id              INT64     not null ,
  cohort_start_date       DATE      not null ,
