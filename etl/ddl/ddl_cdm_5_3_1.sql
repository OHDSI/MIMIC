...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_cohort_definition (
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_attribute_definition (
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_cdm_source
(
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_metadata
(
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_person
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_observation_period
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_specimen
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_death
(
  person_id               INT64     not null ,
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_visit_occurrence
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_visit_detail
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_procedure_occurrence
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_drug_exposure
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_device_exposure
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_condition_occurrence
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_measurement
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_note
(
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_note_nlp
(
  note_nlp_id                 INT64                ,
  note_id                     INT64                ,
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_observation
(
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_fact_relationship
(
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_location
(
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_care_site
(
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_provider
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_payer_plan_period
(
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_cost
(
...
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_cohort
(
  cohort_definition_id  INT64   not null ,
...
--HINT DISTRIBUTE_ON_KEY(subject_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_cohort_attribute
(
  cohort_definition_id    INT64     not null ,
  subject_id              INT64     not null ,
  cohort_start_date       DATE      not null ,
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_drug_era
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_dose_era
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE `@target_project`.@target_dataset.cdm_condition_era
(
