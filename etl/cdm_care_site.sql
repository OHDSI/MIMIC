...
CREATE OR REPLACE TABLE `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_careunit AS
SELECT
...
FROM 
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.src_transfers src
WHERE
...
CREATE OR REPLACE TABLE `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_care_site
(
...
INSERT INTO `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_care_site
SELECT
...
FROM 
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_careunit src
WHERE
    src.careunit IS NOT NULL
;
