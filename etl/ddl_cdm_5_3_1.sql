...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_cohort_definition (
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_attribute_definition (
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_cdm_source
(
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_metadata
(
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_person
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_observation_period
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_specimen
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_visit_occurrence
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_visit_detail
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_procedure_occurrence
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_device_exposure
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_measurement
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_note
(
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_note_nlp
(
  note_nlp_id                 INT64                ,
  note_id                     INT64                ,
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_observation
(
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_fact_relationship
(
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_location
(
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_care_site
(
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_provider
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_payer_plan_period
(
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_cost
(
...
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_cohort
(
  cohort_definition_id  INT64   not null ,
...
--HINT DISTRIBUTE_ON_KEY(subject_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_cohort_attribute
(
  cohort_definition_id    INT64     not null ,
  subject_id              INT64     not null ,
  cohort_start_date       DATE      not null ,
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_drug_era
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_dose_era
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE OR REPLACE TABLE mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_condition_era
(
