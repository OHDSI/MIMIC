...
SELECT
    ...
    DATE_ADD(CAST(src.start_datetime AS DATE), INTERVAL ds.offset_days DAY) AS device_exposure_start_date,
    DATETIME_ADD(src.start_datetime, INTERVAL ds.offset_days DAY) AS device_exposure_start_datetime,
    DATE_ADD(CAST(src.end_datetime AS DATE), INTERVAL ds.offset_days DAY) AS device_exposure_end_date,
    DATETIME_ADD(src.end_datetime, INTERVAL ds.offset_days DAY) AS device_exposure_end_datetime,
...
SELECT
    ...
    DATE_ADD(CAST(src.start_datetime AS DATE), INTERVAL ds.offset_days DAY) AS device_exposure_start_date,
    DATETIME_ADD(src.start_datetime, INTERVAL ds.offset_days DAY) AS device_exposure_start_datetime,
    DATE_ADD(CAST(src.start_datetime AS DATE), INTERVAL ds.offset_days DAY) AS device_exposure_end_date,
    DATETIME_ADD(src.start_datetime, INTERVAL ds.offset_days DAY) AS device_exposure_end_datetime,
    src.type_concept_id                                         AS device_type_concept_id,
    CAST(NULL AS STRING)                                        AS unique_device_id,
    CAST(NULL AS STRING)                                        AS production_id,
    CAST(
