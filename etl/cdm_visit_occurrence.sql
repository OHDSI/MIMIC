...
CREATE OR REPLACE TABLE `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_admissions_emerged AS
SELECT
    hadm_id,
    subject_id,
    admission_location,
...
CREATE OR REPLACE TABLE `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_admissions AS
SELECT
    hadm_id                     hadm_id,
    ...
    load_row_id,
    trace_id
FROM `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_admissions_emerged
;
...
CREATE OR REPLACE TABLE 
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_gcpt_admission_type_to_concept AS
SELECT 
...
--     admission_type AS admission_type,
--     visit_concept_id 
-- FROM gcpt_admission_type_to_concept -- where is the source for this table?
;
...
CREATE OR REPLACE TABLE 
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_gcpt_admission_location_to_concept AS
SELECT 
    ...
    -- admission_location 
-- FROM gcpt_admission_location_to_concept -- where is the source for this table?
;
...
CREATE OR REPLACE TABLE 
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_gcpt_discharge_location_to_concept AS
SELECT 
...
--     discharge_location 
-- FROM gcpt_discharge_location_to_concept -- where is the source for this table?
;
...
CREATE OR REPLACE TABLE `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_visit_occurrence
(
...
INSERT INTO `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_visit_occurrence
SELECT
...
FROM 
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_admissions src
LEFT JOIN 
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_gcpt_admission_location_to_concept la 
        USING (admission_location)
LEFT JOIN 
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_gcpt_discharge_location_to_concept ld
        USING (discharge_location)
LEFT JOIN 
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.tmp_gcpt_admission_type_to_concept lat
        USING (admission_type)
LEFT JOIN
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_person per
        ON CAST(src.subject_id AS STRING) = per.person_source_value
LEFT JOIN 
    `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_care_site cs
