...
(
    SELECT 
        ...
        COUNT(*)                    AS row_count
    FROM
        `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.src_transfers tr
    WHERE 
...
(
    ...
    FROM
        `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.report_qa_row_count
    WHERE
...
(
    SELECT 
        ...
        COUNT(*)                    AS row_count
    FROM 
        `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.src_admissions adm
    WHERE 
...
(
    SELECT 
        ...
        COUNT(*)                    AS row_count
    FROM 
        `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.src_services serv
    INNER JOIN 
        `odysseus-mimic-dev`.mimiciv_cdm_tuf_10_ant_2020_09_11.cdm_visit_occurrence vis 
